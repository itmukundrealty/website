...
const FEATURES: FeatureItem[] = [
  ...
  { icon: "Gymnasium", label: "Open Gymnasium with cardio equipment" },
  ...
  { icon: "Badmintion", label: "Badminton Court" },
  { icon: "OpenLibrary", label: "Library" },
  { icon: "MiniTheatre", label: "Open Air Theatre" },
  { icon: "Meditation", label: "Meditation Pavilion" },

  { icon: "Recreation", label: "Recreational Space" },
  { icon: "VisitorsLounge", label: "Visitor Lounge" },
  { icon: "Solar", label: "Solar Electric Power Panels" },
  { icon: "PowerBackup", label: "24x7 Backup Generators" },
