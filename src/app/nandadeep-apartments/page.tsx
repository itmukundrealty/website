    ...
    return (
        <>
            <div className="">
                ...
                <ProjectHeader />
                <CompletedHero title={<>Nandadeep Apartments</>} subtitle="" variant="center" desktopImage="/images/nandeepImages/heroDesk.webp" mobileImage="/images/nandeepImages/heroMobile.png" />
