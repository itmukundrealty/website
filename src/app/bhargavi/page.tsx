    ...
    return (
        <>
            <div className="">
                ...
                <CTASection title={<>Own a Home <br /> That Matters</>} subtitle="Experience comfort crafted for you." mobImg="/images/ctaImages/bhargaviMob.png" deskImg="/images/ctaImages/bhargaviDesk1.png" />
                <Footer />
            </div>
        </>
    );
