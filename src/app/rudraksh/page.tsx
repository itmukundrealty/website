...
export default function Project1Page() {
    return (
        <main className="min-h-screen bg-black">
            <ProjectHeader />
            <ProjectHero FLOOR_PATHS_VIEWBOX={FLOOR_PATHS_VIEWBOX} heroImageDesktop="/herosectionImage/Herosection (6).png" heroImageMobile="/images/rudrakshImages/mobileHero1.png" HERO_MARKERS={HERO_MARKERS} floorData={floorData} FLOOR_PATHS={FLOOR_PATHS} />
            ...
            <CTASection title={<>Where Luxury <br /> Finds Form</>} subtitle="Built for Enduring Value" mobImg="/images/rudrakshImages/ctaBg.webp" deskImg="/images/rudrakshImages/image.png" />
