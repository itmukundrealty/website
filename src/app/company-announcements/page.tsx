                        ...
                        {announcements.map((item, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Text Content */}
                                    <h3 className="text-lg md:text-[1.5rem] text-[#505153] leading-snug font-normal md:pr-2 mb-3 line-clamp-2 group-hover:text-[#0097DC] transition-colors text-center md:text-left">
                                        {item.title}
                                    </h3>
