        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <main className="flex-grow pt-32 pb-20 px-6 md:px-12 lg:px-24 xl:px-52 max-w-full mx-auto w-full">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
                    ...
                    <Link href="#apply">
                        <button className="bg-[#0097DC] hover:bg-[#007bb5] transition-colors text-white px-8 py-3 pb-3.5 text-lg font-medium">
                            Apply Now
                        </button>
                    </Link>
                </div>
                ...
                {/* Go Back */}
                <div className="mt-20">
                    <Link href="/career" className="inline-flex items-center gap-6 text-[#505153] hover:text-[#505153] transition-colors group">
