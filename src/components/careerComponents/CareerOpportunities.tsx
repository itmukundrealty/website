...
const JobCard = ({ title, type, description, color, slug, i, progress, range, targetScale }: JobCardProps) => {
                ...
                <div className="flex flex-col justify-between h-full p-8 md:p-12 lg:p-16">
                    ...
                    <div className="flex items-center gap-6 mt-auto self-end">
                        ...
                        <Link href={`/career/${slug}`}>
                            <button className="border border-white px-6 py-2 pb-2.5 text-sm md:text-base font-medium hover:bg-white hover:text-[#0097DC] transition-colors">
                                Apply Now
                            </button>
                        </Link>
                    </div>
...
export default function CareerOpportunities() {
    ...
    return (
        <div ref={container} className="relative pb-[20vh] bg-white px-6 lg:px-20 xl:px-52 pt-20">
