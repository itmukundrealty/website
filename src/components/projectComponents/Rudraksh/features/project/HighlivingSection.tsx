...
export default function HighlivingSection({ heading, description, imageSrc, videoSrc, projectLink = "/project-enquire" }: HighlivingSectionProps) {
    ...
    <section className="py-24 bg-white font-sans">
      <div className=" mx-auto px-6 lg:px-20 xl:px-54">
        ...
        <div className="relative w-full aspect-video md:aspect-21/9 rounded-sm overflow-hidden shadow-2xl bg-gray-100 group">
          {!isPlaying ? (
            <>
              <Image src={imageSrc} alt={heading} fill className="object-cover cursor-pointer" onClick={() => setIsPlaying(true)} priority />
              {/* Play Button Overlay */}
              <div
