    ...
    <section className="relative h-[100vh] w-full overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <div className="hidden lg:block h-full w-full">
          <Image
            src={isZoomedOut ? "/herosectionImage/Img2.png" : "/herosectionImage/heroection.png"}
      ...
      {/* 2. HERO TEXT CONTENT */}
      {/* Changed items-center -> items-start. Removed all vertical padding */}
      <div className="relative z-10 hidden lg:flex h-full items-start justify-end px-12 lg:px-24 pointer-events-none">
        <motion.div
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8, delay: 0.5 }}
          /* USE MARGIN-TOP HERE TO CONTROL HEIGHT */
      ...
      <div
        className={`absolute inset-0 z-5 pointer-events-none transition-opacity duration-700 hidden lg:block ${isZoomedOut ? "opacity-0" : "opacity-100"}`}
      >
        <svg viewBox="0 0 1728 1048" className="h-full w-full object-fill pointer-events-auto" preserveAspectRatio="none">
          <g className="fill-transparent transition-colors duration-300">
            ...
            <path
              ...
              className={getBuildingPathClass(0)}
            ...
            <path
              ...
              className={getBuildingPathClass(1)}
            ...
            <path
              ...
              className={getBuildingPathClass(2)}
            ...
            <path
              ...
              className={getBuildingPathClass(3)}
            ...
            <path
              ...
              className={getBuildingPathClass(4)}
            ...
            <path
              ...
              className={getBuildingPathClass(5)}
            ...
            <path
              ...
              className={getBuildingPathClass(6)}
            ...
            <path
              ...
              className={getBuildingPathClass(7)}
            ...
            <path
              ...
              className={getBuildingPathClass(8)}
            ...
            <path
              ...
              className={getBuildingPathClass(9)}
            ...
            <path
              ...
              className={getBuildingPathClass(10)}
            ...
            <path
              ...
              className={getBuildingPathClass(11)}
            ...
            <path
              ...
              className={getBuildingPathClass(12)}
            ...
            <path
              ...
              className={getBuildingPathClass(13)}
            ...
            <path
              ...
              className={getBuildingPathClass(14)}
            ...
            <path
              ...
              className={getBuildingPathClass(15)}
            ...
            <path
              ...
              className={getBuildingPathClass(16)}
          ...
          {HERO_MARKERS.map((marker, index) => (
            ...
            >
              {/* Connector Line */}
              <line x1={marker.cx} y1={marker.cy + 30} x2={marker.cx} y2={marker.cy + 90} stroke="white" strokeWidth="2" />
              {/* Circle Background */}
              <circle cx={marker.cx} cy={marker.cy} r="31" fill="white" opacity="0.5" stroke="white" strokeWidth="0.5" />
              <circle cx={marker.cx} cy={marker.cy} r="30" fill="none" stroke="white" strokeWidth="2" />
              {/* Icon Path rendered here */}
              <g transform={`translate(${marker.cx - 31.5}, ${marker.cy - 31.5})`}>{marker.iconPath}</g>
            </g>
          ))}
        </svg>
      </div>
          ...
          >
            <div>
              ...
              <ul className="mb-8 space-y-2">
                {floorData[hoveredIndex].features.map((feature, idx) => (
                  ...
                  <div className="relative h-full w-full">
                    ...
                    >
                      <g className="transition-all duration-300">
                        {currentFloor.units.map((unit, index) => (
                          <path
                            key={unit.id}
                            d={unit.path}
