                ...
                <div className="md:col-span-12 lg:col-span-4 flex flex-col">
                    ...
                    <div className="space-y-6 md:space-y-5 lg:pl-1 mt-2">
                        <div className="flex gap-4 md:gap-5 items-start">
                            <Send size={18} className="text-[#009FE3] mt-7 shrink-0 rotate-[315deg]" strokeWidth={1.5} />
            ...
            <div className="w-full flex flex-col items-center mb-16 px-4">
                ...
                <div className="space-y-6 w-full max-w-[320px]">
                    <div className="flex gap-5 items-start">
                        <Send size={18} className="text-[#009FE3] mt-1.5 shrink-0 rotate-[315deg]" />
             ...
             <div className="w-full border-t border-slate-100 pt-10 pb-6 text-center">
