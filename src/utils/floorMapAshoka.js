...
export const floorData = [
    ...
    units: [
      {
        ...
        details: {number: "Co-working Space"},
      },
      {
        id: "G02",
        ...
        details: {number: "Franchise Space"},
      },
      {
        id: "G03",
  ...
  // Floor 2 to 12 use the typical layout
  {
    ...
    units: [
      ...
      {
        id: "224",
        unitImage: "/floorPlans/ashoka/floorMapAndSpeceficMapImages/floor2/24.png",
        path: "M425.266 603V450.25H555.031V603H425.266Z",
    ...
    units: [
      {
        ...
        path: "M176.267 23.125H158.906V145.719H166.5V154.719H287.375V21.0234H176.267V23.125Z",
        details: { number: "Shop Space No. 404A", sqft: "1622 "},
      },
      {
        id: "402",
  ...
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        details: { number: "Common Terrace Space"},
      }
    ]
  }
  // Floor 2 to 12 use the typical layout
