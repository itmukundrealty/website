const typicalFloorUnits = [
  {
    ...
    details: { number: "01", type: "3BHK", sqft: "1650", balconySqft: "125", rooms: 3, washrooms: 3, floor: "2nd to 12th Floor" }
  },
  {
    id: "202",
    ...
    details: { number: "02", type: "3BHK", sqft: "1680", balconySqft: "140", rooms: 3, washrooms: 3, floor: "2nd to 12th Floor" }
  },
  {
    id: "203",
    ...
    details: { number: "03", type: "2BHK", sqft: "1250", balconySqft: "95", rooms: 2, washrooms: 2, floor: "2nd to 12th Floor" }
  },
  {
    id: "204",
    ...
    details: { number: "04", type: "2BHK", sqft: "1300", balconySqft: "98", rooms: 2, washrooms: 2, floor: "2nd to 12th Floor" }
  },
  {
    id: "205",
    ...
    details: { number: "05", type: "2BHK", sqft: "1280", balconySqft: "92", rooms: 2, washrooms: 2, floor: "2nd to 12th Floor" }
  },
  {
    id: "206",
    ...
    details: { number: "06", type: "3BHK", sqft: "1550", balconySqft: "110", rooms: 3, washrooms: 2, floor: "2nd to 12th Floor" }
  },
  {
    id: "207",
    ...
    details: { number: "07", type: "3BHK", sqft: "1600", balconySqft: "135", rooms: 3, washrooms: 3, floor: "2nd to 12th Floor" }
  },
  {
    id: "208",
    ...
    details: { number: "08", type: "2BHK", sqft: "1350", balconySqft: "105", rooms: 2, washrooms: 2, floor: "2nd to 12th Floor" }
  },
  {
    id: "209",
    ...
    details: { number: "09", type: "2BHK", sqft: "1400", balconySqft: "115", rooms: 2, washrooms: 2, floor: "2nd to 12th Floor" }
  },
  {
    id: "210",
    ...
    details: { number: "10", type: "4BHK Penthouse", sqft: "2200", balconySqft: "450", rooms: 4, washrooms: 4, floor: "2nd to 12th Floor" }
  }
];
...
export const floorData = [
  {
    ...
    features: ["24×7 Cloud Kitchen", "Entrance Lobby", "Yoga Lawn", "Play Areas"],
    units: [
      {
        id: "G01",
        unitImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/ground/0.png",
        ...
        details: { number: "G01", type: "Ground Retail", sqft: "1800", balconySqft: "150", rooms: 1, washrooms: 1, floor: "Ground Floor" }
      },
      {
        id: "G02",
        ...
        details: { number: "G02", type: "Office Space", sqft: "1200", balconySqft: "0", rooms: 1, washrooms: 1, floor: "Ground Floor" }
      },
      {
        id: "G03",
        ...
        details: { number: "G03", type: "Kiosk", sqft: "400", balconySqft: "0", rooms: 0, washrooms: 0, floor: "Ground Floor" }
      },
      {
        id: "G04",
        ...
        details: { number: "G04", type: "Office Space", sqft: "1150", balconySqft: "0", rooms: 1, washrooms: 1, floor: "Ground Floor" }
      },
      {
        id: "G05",
        unitImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/ground/4.png",
        // This path contains a hole. 'fillRule: evenodd' ensures the hole is not filled.
        fillRule: "evenodd", 
        path: "M334.625 384.062L312.125 410.438L425.943 506.543L464.299 461.302L446.921 446.127L446.546 445.799L446.872 445.423L469.697 419.047L591.938 523.681L583.916 533.959L589.18 539.223L588.881 539.574L577.053 553.459L576.672 553.127L571.302 548.457L568.308 551.951L562.434 547.015L559.836 550.062L566.4 555.438L554.043 569.843L547.913 564.214L542.466 570.439L548.899 575.718L536.715 589.982L536.335 589.665L530.371 584.671L501.182 619.049L287.055 436.577L285.059 438.824L234.545 396.562L282.188 339.796L334.625 384.062ZM437.625 511.375L465.062 534.75L476 522L448.75 498.562L437.625 511.375Z",
        details: { number: "G05", type: "Large Showroom", sqft: "2500", balconySqft: "200", rooms: 2, washrooms: 2, floor: "Ground Floor" }
      },
      {
        id: "G06",
        unitImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/ground/5.png",
        path: "M435 285.75L411.5 313.5L562.5 441.75L560.25 445.5L641.75 516L664.5 488.25L623.922 453.281L624.352 452.727L583.125 417.625L585.844 414.375L435 285.75Z",
        details: { number: "G06", type: "Office Space", sqft: "1400", balconySqft: "0", rooms: 1, washrooms: 1, floor: "Ground Floor" }
      },
      {
        id: "G07",
        unitImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/ground/6.png",
        path: "M443.5 397.625L420 424.5L350.625 365.75L373.5 337.875L443.5 397.625Z",
        details: { number: "G07", type: "Office Space", sqft: "1250", balconySqft: "0", rooms: 1, washrooms: 1, floor: "Ground Floor" }
      },
      {
        id: "G08",
        ...
        details: { number: "G08", type: "Small Office", sqft: "700", balconySqft: "0", rooms: 1, washrooms: 0, floor: "Ground Floor" }
      },
      {
        id: "G09",
        ...
        details: { number: "G09", type: "Corner Showroom", sqft: "1600", balconySqft: "140", rooms: 2, washrooms: 2, floor: "Ground Floor" }
      },
      {
        id: "G10",
        unitImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/ground/9.png",
        ...
        details: { number: "G10", type: "Office Space", sqft: "1350", balconySqft: "0", rooms: 1, washrooms: 1, floor: "Ground Floor" }
      },
      {
        id: "G11",
        unitImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/ground/10.png",
        path: "M301 356.5L340.875 310.625L373.75 338.25L333.625 384.125L301 356.5Z",
        details: { number: "G11", type: "Office Space", sqft: "1300", balconySqft: "0", rooms: 1, washrooms: 1, floor: "Ground Floor" }
      }
    ]
  },
  {
    ...
    features: ["Spacious 2BHK Apartments", "Private Balconies", "Advanced Security"],
    units: [
      {
        id: "101",
  ...
  { 
    ...
    features: ["Luxury 3BHK Suites", "Smart Home Automation", "Premium Flooring"], 
    units: typicalFloorUnits 
  },
  { 
    title: "Third Floor", 
    planImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/floor2-12/floor.png", 
    features: ["Designer Concept Flats", "Natural Ventilation", "High Ceilings"], 
    units: typicalFloorUnits 
  },
  { 
    title: "Fourth Floor", 
    planImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/floor2-12/floor.png", 
    features: ["Penthouse Collection", "Sky Garden Access", "Exclusive Elevators"], 
    units: typicalFloorUnits 
  },
  { 
    title: "Fifth Floor", 
    planImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/floor2-12/floor.png", 
    features: ["Mid-Rise Vista Units", "Panoramic Views", "Modern Kitchens"], 
    units: typicalFloorUnits 
  },
  { 
    title: "Sixth Floor", 
    planImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/floor2-12/floor.png", 
    features: ["Family Residences", "Dedicated Play Zone", "Noise Insulation"], 
    units: typicalFloorUnits 
  },
  { 
    title: "Seventh Floor", 
    planImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/floor2-12/floor.png", 
    features: ["Executive Suites", "Home Office Spaces", "Centralized Cooling"], 
    units: typicalFloorUnits 
  },
  { 
    title: "Eighth Floor", 
    planImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/floor2-12/floor.png", 
    features: ["Zen Living Spaces", "Indoor Plant Nooks", "Eco-friendly Materials"], 
    units: typicalFloorUnits 
  },
  { 
    title: "Ninth Floor", 
    planImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/floor2-12/floor.png", 
    features: ["Sky-high Luxury", "Triple Height Atriums", "Butler Service"], 
    units: typicalFloorUnits 
  },
  { 
    title: "Tenth Floor", 
    planImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/floor2-12/floor.png", 
    features: ["The Apex Suites", "Private Terrace Pools", "Smart Lighting"], 
    units: typicalFloorUnits 
  },
  { 
    title: "Eleventh Floor", 
    planImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/floor2-12/floor.png", 
    features: ["Cloud Residency", "Glass Wall Interiors", "Concierge App"], 
    units: typicalFloorUnits 
  },
  { 
    title: "Twelfth Floor", 
    planImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/floor2-12/floor.png", 
    features: ["Summit Penthouses", "360° City Overview", "Private Helipad Access"], 
    units: typicalFloorUnits 
  },
  {
    title: "Thirteenth Floor",
    planImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/floor13/floor.png",
    features: ["Infinity Rooftop Pool", "Sky Bar & Lounge", "Observation Deck", "Starside Observatory"],
    units: [
      {
        id: "1301",
  ...
  },
  {
    ...
    units: [
      {
        id: "T-01",
        unitImage: "/floorPlans/rudrarsh/floorMapAndSpeceficMapImages/terrace/pool.png",
